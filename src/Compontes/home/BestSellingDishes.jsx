...
import shape1 from "../../assets/best_selling2.png";
...
export default function BestSellingDishes() {
  ...
  src={shape1}
  alt="shape"
  className="floating-shape float-updown"
/>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 h-[1200px]">
          {product.map((item, i) => (
