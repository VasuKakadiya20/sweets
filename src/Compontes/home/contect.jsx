...
// import shape3 from "../../assets/aboutShape1_3.png";
// import shape4 from "../../assets/aboutShape1_4.png";
// import shape6 from "../../assets/aboutShape1_6.png";
...
//       <img src={shape3} className="shape shape3 rotate" alt="" />
//       <img src={shape4} className="shape shape4" alt="" />
//       <img src={shape6} className="shape shape6 rotate" alt="" />

//       <div className="container about-bg-wrapper">
//         <img src={bg_img} className="about-bg-img" alt="bg sweets" />
...
//           <a href="/menu" className="theme-btn">
//             ORDER NOW <i className="bi bi-arrow-right text-white"></i>
//           </a>
//         </div>
//       </div>
//     </section>
