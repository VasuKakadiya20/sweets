...
// import shape4 from "../../assets/aboutShape1_4.png";
import pista from "../../assets/pista.png"; // your uploaded image
import shape3 from "../../assets/Strwbarry Chikki.png";
import "./AboutSection.css";
...
export default function AboutSectionHome() {
  return (
    <section className="relative py-[140px] bg-white overflow-hidden">
      <img src={shape1} className="absolute rounded-[0%_50%_50%_0%] top-10 left-0 hidden 2xl:block h-[562px] w-[442px]" alt="" />
      <img src={pista} className="absolute top-10 left-93 hidden 2xl:block h-[150px] w-[150px]" alt="" />
      <img src={shape3} className="absolute bottom-40 left-[90px] rotate hidden 2xl:block h-[358px] w-[362px] rounded-full" alt="" />
      <img src={shape4} className="absolute rounded-[50%_0%_0%_50%] top-10 right-0 hidden 2xl:block h-[562px] w-[442px]" alt="" />
       <img src={pista} className="absolute bottom-10 right-90 hidden 2xl:block h-[150px] w-[150px]" alt="" />
      <img src={shape3} className="absolute bottom-40 right-[90px] rotate hidden 2xl:block h-[350px] w-[355px] rounded-full" alt="" />
